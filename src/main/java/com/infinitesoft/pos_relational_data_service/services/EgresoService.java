...
public interface EgresoService {
    ...
    List<Egreso> findAll();
    Page<Egreso> search(String descripcion, Long tipoEgresoId, String naturaleza, Long proveedorId, Long personaId, LocalDate fechaInicio, LocalDate fechaFin, Pageable pageable);
